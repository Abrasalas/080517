...
class PokemonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post pokemons_url, params: { pokemon: { level: @pokemon.level, name: @pokemon.name, nature: @pokemon.nature } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { level: @pokemon.level, name: @pokemon.name, nature: @pokemon.nature } }
